<template>
    <div class="flex flex-col w-full sm:w-1/4">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <button
                class="flex justify-between items-center px-6 py-2 w-full focus:outline-none hover:bg-purple-600 hover:text-gray-50"
                ...
                <inertia-link
                    ...
                    :class="
                        route().current('admin.admins.*')
                            ...
                            : 'hover:text-gray-50 hover:bg-purple-600'
                    "
                    >Admins</inertia-link
                >
                <inertia-link
            ...
            <inertia-link
                ...
                class="flex justify-between items-center border-t px-6 py-2 capitalize hover:bg-purple-600 hover:text-gray-50"
            >
                Dashboard
            </inertia-link>
        </div>
