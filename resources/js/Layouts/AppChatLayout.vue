<template>
    <div class="flex flex-col min-h-screen">
                            ...
                            <jet-dropdown align="right" width="96">
                                ...
                                >
                                    <inertia-link
                                        ...
                                        class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-purple-600 hover:text-gray-50 focus:outline-none focus:bg-purple-600 focus:text-gray-50 transition duration-150 ease-in-out"
                                    >
                                        Mark all as read
                                    </inertia-link>
        ...
        <div class="flex flex-wrap pt-16 sm:flex-nowrap">
            ...
            <!-- Page Content -->
            <main
                class="bg-gray-200 shadow rounded my-5 py-6 px-4 w-full sm:mx-2 sm:my-3 md:mx-4 md:px-10 lg:mx-auto"
            >
                <slot></slot>
            </main>
        </div>
