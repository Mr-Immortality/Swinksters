<template>
    <div class="flex flex-col min-h-screen">
        <nav
            class="bg-purple-600 text-gray-50 border-b border-gray-100 w-full fixed z-20"
        >
                ...
                <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <!-- Account Management -->
                                    <div
                                        class="block px-4 py-2 text-xs text-purple-600 font-bold"
                                    >
                                        Manage Account
                                    </div>
                            ...
                            <jet-dropdown align="right" width="96">
                                ...
                                >
                                    <inertia-link
                                        ...
                                        class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-purple-600 hover:text-gray-50 focus:outline-none focus:bg-purple-600 ocus:text-gray-50 transition duration-150 ease-in-out"
                                    >
                                        Mark all as read
                                    </inertia-link>
                                ...
                                <template #content v-else>
                                    <div
                                        class="block text-center px-4 py-2 text-xs text-purple-600 font-bold"
                                    >
                    ...
                    <div class="-mr-2 flex items-center sm:hidden">
                        <button
                            ...
                            "
                            class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-purple-300 focus:outline-none focus:bg-purple-300 focus:text-gray-500 transition duration-150 ease-in-out"
                        >
                            <svg
                                class="h-6 w-6 fill-current text-gray-50"
                                stroke="currentColor"
                                fill=""
                                viewBox="0 0 24 24"
                            >
            ...
            >
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div>
                            <div
                                class="font-medium text-base text-gray-50 font-bold"
                            >
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link
                            ...
                            :active="route().current('chat-rooms.index')"
                        >
                            Chat Rooms
                        </jet-responsive-nav-link>
        ...
        <div class="flex flex-wrap pt-16 sm:flex-nowrap">
            ...
            <!-- Page Content -->
            <main
                class="bg-gray-200 shadow rounded my-5 py-6 px-4 w-full sm:w-2/3 sm:mx-2 sm:my-3 md:mx-4 md:px-10 lg:mx-auto"
            >
                <slot></slot>
            </main>
        </div>
